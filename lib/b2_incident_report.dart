/*
  Programming of this feature by Dr. Ekong
 */
...
const String  _appBarTitle = 'Report an Incident';
...
class ReportIncident extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String imgLoc      = "assets/images/mu6.png";
    String txtUnderImg = '\nSend email to Merpo at \none of these campuses';
    ...
    return PopScope(
                ...
                child: Scaffold(
                                ...
                                // body:  const  _ReportIncidentBody( ),

                                body: selectCampusBody(context, incidentReportStr, imgLoc,
                                                       txtUnderImg, null),
                        ),  // Scaffold
